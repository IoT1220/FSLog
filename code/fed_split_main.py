...
if __name__=='__main__':
    ...
    # Client-side temporal EMA state for personalized Heads.
    # Kept on CPU because aggregation/EMA is performed after moving models to CPU.
    head_ema_state_list = [
    ...
    if is_train:
        ...
        for it in range(global_epochs):
            ...
            if is_ema:
                # Server-side sequential Transformer EMA.
                # delta1=1.0 keeps server_model unchanged, i.e., pure FedAvg.
                ...
                for i in range(world_size-1):
                    ...
                    # Client-side temporal Head EMA.
                    # delta2=0.0 uses the current local Head directly, i.e., no Head EMA.
                ...
                for i in range(world_size-1):
                    # w/o EMA under the paper definition:
                    # server uses FedAvg Transformer; client Head keeps current local update.
